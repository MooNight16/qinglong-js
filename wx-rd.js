...
微信阅读
阅读入口，复制链接微信打开
https://zl1214232619-1314804847.cos.ap-nanjing.myqcloud.com/index.html?upuid=10735688

备用链接
https://zl1214232622-1314804847.cos.ap-nanjing.myqcloud.com/index.html?upuid=10735688
...
每日30篇 6轮180篇文章
约2.2元 1/天收益
定时一小时一次 一天跑6次或直接手动跑0
限制了先停一天，一般24小时就会恢复正常
*/
...
let userCount = 0
var msg = ''
let newurl = "http://m.zdvnajg.work"
///////////////////////////////////////////////////////////////////
class UserInfo {
    constructor(str) {
        //console.log(str)
...
function popu(url, body = '',ck) {
    ...
    let urlObject = {
        ...
        headers: {
            ...
            "Accept": "*/*",
            "User-Agent": "Mozilla/5.0 (Linux; Android 13; M2102K1C Build/TKQ1.220829.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.141 Mobile Safari/537.36 XWEB/5015 MMWEBSDK/20230202 MMWEBID/2547 MicroMessenger/8.0.33.2320(0x28002151) WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64",
...
function popugethost(url, body = '',ck) {
    ...
    let urlObject = {
        ...
        headers:   {
            ...
            "User-Agent": "Mozilla/5.0 (Linux; Android 13; M2102K1C Build/TKQ1.220829.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.141 Mobile Safari/537.36 XWEB/5015 MMWEBSDK/20230202 MMWEBID/2547 MicroMessenger/8.0.33.2320(0x28002151) WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64",
            "Accept": "*/*",
            "Origin": "https://zl1223203436-1314804847.cos.ap-nanjing.myqcloud.com",
            "X-Requested-With": "com.tencent.mm",
            "Referer": "https://zl1223203436-1314804847.cos.ap-nanjing.myqcloud.com/"
        },
        timeout: 5000,
    }
    if (body) {
